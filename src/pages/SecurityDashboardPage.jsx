...
export default function SecurityDashboardPage({ currentUser }) {
  ...
  const displayData = isDashboardLoading ? {
    threshold: 5,
    ip_activity: [],
    blocked_ips: [],
    token_stats_by_staff: [],
    locked_users: []
  } : data;
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
        <div className="card">
          ...
          <div style={{ fontSize: '28px', fontWeight: 700, marginTop: '4px', color: 'var(--color-primary)' }}>
            {isDashboardLoading ? <Skeleton width={50} height={28} /> : displayData.threshold} <span style={{ fontSize: '13px', color: 'var(--color-muted)', fontWeight: 400 }}>failed attempts</span>
          </div>
        ...
        <div className="card">
          ...
          <div style={{ fontSize: '28px', fontWeight: 700, marginTop: '4px', color: (displayData.ip_activity || []).filter(i => i.is_suspicious).length > 0 ? 'var(--color-error)' : 'var(--color-success)' }}>
            {isDashboardLoading ? <Skeleton width={50} height={28} /> : ((displayData.ip_activity || []).filter(i => i.is_suspicious).length || 0)}
          </div>
        ...
        <div className="card">
          ...
          <div style={{ fontSize: '28px', fontWeight: 700, marginTop: '4px', color: 'var(--color-ink)' }}>
            {isDashboardLoading ? <Skeleton width={50} height={28} /> : ((displayData.token_stats_by_staff || []).reduce((acc, s) => acc + s.total_tokens, 0) || 0)}
          </div>
        ...
        <div className="table-container">
          <table>
            ...
            <tbody>
              {isDashboardLoading ? (
              ...
              ) : displayData.ip_activity.length === 0 ? (
                <tr>
                ...
                displayData.ip_activity.map(ipRow => (
        ...
        <div className="table-container">
          <table>
            ...
            <tbody>
              ...
              ) : !displayData.blocked_ips || displayData.blocked_ips.length === 0 ? (
                <tr>
        ...
        <div className="table-container">
          <table>
            ...
            <tbody>
              {isDashboardLoading ? (
              ...
              ) : displayData.token_stats_by_staff.length === 0 ? (
                <tr>
                ...
                displayData.token_stats_by_staff.map(staff => (
        ...
        <div className="table-container">
          <table>
            ...
            <tbody>
              {isDashboardLoading ? (
              ...
              ) : !displayData.locked_users || displayData.locked_users.length === 0 ? (
                <tr>
                  <td colSpan="6" style={{ textAlign: 'center', padding: '20px' }} className="caption">
                ...
                displayData.locked_users.map(user => (
                  <tr key={user.id}>
